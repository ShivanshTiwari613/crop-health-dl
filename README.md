...
<!-- Paste from results/RESULTS.md (make table). Numbers must come from committed runs. -->

_No full runs committed yet. Table is generated by `make table` from `results/*/metrics.json`._
